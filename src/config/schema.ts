...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.peers": "Peer Bots",
  "tools.peers.enabled": "Enable Peer Bots",
  "tools.peers.allow": "Peer Allowlist",
  "tools.peers.peers": "Peer Bots List",
  "tools.peers.peers[].id": "Peer ID",
  "tools.peers.peers[].label": "Peer Label",
  "tools.peers.peers[].url": "Peer Gateway URL",
  "tools.peers.peers[].token": "Peer Gateway Token",
  "tools.peers.peers[].password": "Peer Gateway Password",
  "tools.peers.peers[].tlsFingerprint": "Peer TLS Fingerprint",
  "tools.peers.peers[].agentId": "Peer Agent ID",
  "tools.peers.peers[].sessionKey": "Peer Session Key",
  "tools.peers.peers[].enabled": "Peer Enabled",
  ...
  "agents.defaults.selfImprove": "Self Improve",
  "agents.defaults.selfImprove.enabled": "Enable Self Improve",
  "agents.defaults.selfImprove.prompt": "Self Improve Prompt",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.peers.peers[].label": "Human-friendly peer label.",
  "tools.peers.peers[].url": "Peer gateway WebSocket URL.",
  "tools.peers.peers[].token": "Peer gateway token (recommended).",
  "tools.peers.peers[].password": "Peer gateway password (optional).",
  "tools.peers.peers[].tlsFingerprint": "Peer gateway TLS fingerprint (SHA-256).",
  "tools.peers.peers[].agentId": "Default agent id on the peer.",
  "tools.peers.peers[].sessionKey": "Default session key on the peer.",
  "tools.peers.peers[].enabled": "Enable/disable this peer entry.",
  ...
  "agents.defaults.selfImprove":
    "Optional system prompt hinting for self-improvement (disabled by default).",
  "agents.defaults.selfImprove.enabled": "Enable auto-improvement prompt injection.",
  "agents.defaults.selfImprove.prompt":
    "Custom prompt appended to the system prompt when self-improve is enabled.",
